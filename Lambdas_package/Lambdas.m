...
% November 2017. (Last updated: January 25, 2018)
...
%             i (Px3 matrix, P = number of particles). Optional input, 
%             only required if mode=-1 or mode='dipolar_max'.
%¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡
...
% OUTPUTS:
%   Lambda_0    : classical eigenvalue (see [1]).
%   Lambda_T    : perpendicular Lambda (see [1]).
%   Lambda_II   : parallel Lambda (see [1]).
%   Sig         : charge distribution for the selected mode.

    
function [Lambda_0, Lambda_T, Lambda_II, Sig] = Lambdas(p, op, mode, dirs)
    ...
    switch nargin
        ...
        case 4
            ...
            elseif size(dirs,1)>P
                error('Error in Lambdas(): too many dipole directions specified.');
            end
    end
    ...
    if sum(mode) == 0 || sum(mode) == -1 || strcmp(mode,'dipolar_max')
